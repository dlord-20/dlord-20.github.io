...
export default function BlogArticle() {
    ...
    //Effect for fading in section by section yay woah man missed a day :( few days left yep - cruise - parents- one day more - Picking up the parents tonight - cruise tomorrow
